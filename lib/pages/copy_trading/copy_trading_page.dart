...
class _CopyTradingPageState extends State<CopyTradingPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildFollowingTab() {
    return Consumer<CopyTradingProvider>(
      builder: (context, provider, child) {
        final followingWallets = provider.wallets.where((w) => w.isFollowing).toList();
