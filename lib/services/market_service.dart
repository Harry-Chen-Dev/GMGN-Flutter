  ...
  Future<List<MarketToken>> getMarketTokens() async {
    ...
    return [
      MarketToken(
        ...
        high24h: 39120.89,
        low24h: 37456.32,
        sparklineData: List.generate(
            24, (index) => 38520.60 + (random.nextDouble() - 0.5) * 2000),
      ),
      MarketToken(
        id: 'ethereum',
        symbol: 'ETH',
        ...
        low24h: 1987.43,
        sparklineData: List.generate(
            24, (index) => 2001.24 + (random.nextDouble() - 0.5) * 100),
      ),
      MarketToken(
        id: 'solana',
        symbol: 'SOL',
        ...
        low24h: 29.87,
        sparklineData: List.generate(
            24, (index) => 31.02 + (random.nextDouble() - 0.5) * 3),
      ),
      MarketToken(
        id: 'cardano',
        symbol: 'ADA',
        ...
        low24h: 0.4321,
        sparklineData: List.generate(
            24, (index) => 0.4523 + (random.nextDouble() - 0.5) * 0.05),
      ),
      MarketToken(
        id: 'polkadot',
        symbol: 'DOT',
        ...
        low24h: 6.54,
        sparklineData: List.generate(
            24, (index) => 6.78 + (random.nextDouble() - 0.5) * 0.8),
      ),
      MarketToken(
        id: 'chainlink',
        symbol: 'LINK',
        ...
        low24h: 13.87,
        sparklineData: List.generate(
            24, (index) => 14.56 + (random.nextDouble() - 0.5) * 1.5),
      ),
    ];
  }
